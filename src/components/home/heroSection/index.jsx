...
const Hero = () => {
  return (
    <div className='grid md:grid-cols-2 px-10 lg:px-[100px] pt-[100px] md:pt-[200px] pb-[70px] bg-gray-50 dark:bg-inherit gap-10 text-center md:text-left'>
      <div className='grid gap-10 lg:mr-10'>
        <h1 className='text-3xl lg:text-5xl font-bold text-[#D39D55] dar:text-inherit'> Empowering African businesses through technology:</h1>
